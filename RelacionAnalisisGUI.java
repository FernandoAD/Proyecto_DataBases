...
public class RelacionAnalisisGUI extends JFrame implements ActionListener{
  ...
  public RelacionAnalisisGUI(){
    super("Gestion de Relacion Analisis");
  ...
  public static void main(String args[]){
    RelacionAnalisisGUI relacionanalisis= new RelacionAnalisisGUI();
    relacionanalisis.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
  }
}
